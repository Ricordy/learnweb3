...
const contractABI = [{
    ...
    },
    {
        ...
        "name": "extensions",
        "outputs": [{
            "internalType": "contract INFTExtension",
            "name": "",
            "type": "address"
        }],
        "stateMutability": "view",
...
const YOUR_CONTRACT_ADDRESS = "0xa8ff39651d4ef92c3de6f9f17e39e0182650ac9f";
...
export default function App() {
    ...
    let mint = async() => {
        let mint = await getContract().mint(1);
